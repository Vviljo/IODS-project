...
From the summary one can see the variances of subjects and the correlation of fixed effects.
...
ANOVA for random intercept random slope model vs the random slope and random intercept and time*group interaction model.
